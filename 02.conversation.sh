...
echo -e "/e[31m trumph :: hii rs gsndu "
echo -e "/e[32m modi :: cheppu macha em katta "
echo -e "/e[33m trumph :: em bha pakistan ki chukalli chipincharu antta gha"
echo -e "/e[34m modi  :: eddo ra bha edo alla russia maa macha putin help cheysadu lee "
